...
public static class TypeMappings
{
        ...
        new Dictionary<BackendType, IReadOnlyDictionary<CanonicalType, string>>
    {
        ...
        [BackendType.DBase] = new Dictionary<CanonicalType, string>
        {
            ...
            [CanonicalType.Double]   = "FLOAT",
            [CanonicalType.Decimal]  = "NUMERIC(18,4)",
            [CanonicalType.Date]     = "DATE",
            [CanonicalType.DateTime] = "DATE",         // dBase has no TIMESTAMP; DATE is the closest
        ...
        new Dictionary<BackendType, string>
    {
        ...
        [BackendType.Oracle]    = "NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY",
        [BackendType.DB2]       = "INT GENERATED BY DEFAULT AS IDENTITY",
        [BackendType.Firebird]  = "INTEGER GENERATED BY DEFAULT AS IDENTITY",
        [BackendType.DBase]     = "INTEGER",  // ACE OleDb ne podržava AUTOINC pouzdano
    };
